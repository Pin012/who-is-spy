...
const HomeView: React.FC<HomeViewProps> = ({ onCreateClick, onJoin, findGame, loading, playerName, setPlayerName }) => {
  ...
  return (
    <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto px-4">
      ...
      <div className="glass p-8 md:p-10 rounded-2xl shadow-2xl space-y-10 animate-in fade-in slide-in-from-left duration-700 relative overflow-hidden border border-white/10">
        ...
        <div className="space-y-3 relative z-10">
          <h1 className="text-6xl md:text-7xl font-black tracking-tighter text-white leading-[0.85] drop-shadow-sm">
        ...
        <div className="space-y-8 relative z-10">
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              placeholder="請輸入你的名字"
              className="w-full bg-black/50 border border-white/5 rounded-lg px-6 py-5 focus:ring-2 focus:ring-red-600 outline-none transition-all text-white text-lg font-bold placeholder:text-zinc-800 shadow-inner"
            />
          </div>
          ...
          <div className="space-y-6">
             ...
             <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    maxLength={6}
                    placeholder="CODE"
                    className="flex-1 bg-black border border-white/5 rounded-lg px-6 py-4 text-center font-mono text-xl tracking-[0.4em] text-red-500 focus:border-red-600/50 outline-none transition-all shadow-inner"
                  />
                  <button
                    onClick={handleJoin}
                    disabled={loading}
                    className="bg-red-600 hover:bg-red-500 text-white px-8 rounded-lg font-black uppercase tracking-widest transition-all disabled:opacity-50 active:scale-95 shadow-lg shadow-red-900/20 text-sm"
                  >
                    Join
                  </button>
                </div>
             ...
             <button
                ...
                disabled={loading}
                className="w-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 text-white font-black py-5 rounded-lg transition-all active:scale-95 disabled:opacity-50 uppercase tracking-[0.3em] text-sm"
              >
                Establish New Room
              </button>
          </div>
      ...
      <div className="space-y-10 animate-in fade-in slide-in-from-right duration-700 delay-200">
        <div className="space-y-6">
          ...
          <div className="grid gap-4">
            {[
              ...
              <div key={idx} className="bg-white/5 p-6 rounded-xl border border-white/5 space-y-2 group hover:bg-white/10 transition-colors relative overflow-hidden">
        ...
        <div className="p-8 rounded-xl bg-gradient-to-br from-red-900/10 to-transparent border border-red-900/20 relative overflow-hidden group shadow-xl">
