          ...
          <div className="sticky top-24 space-y-8">
            ...
            >
              ...
              >
                ...
                >
                   <div className={`absolute top-0 inset-x-0 h-1.5 ${cardColor === 'red' ? 'bg-red-600 text-red-400' : cardColor === 'cyan' ? 'bg-cyan-400 text-cyan-300' : 'bg-amber-500 text-amber-300'} shadow-[0_0_6px_rgba(255,255,255,0.6),0_0_24px_currentColor]`}></div>
