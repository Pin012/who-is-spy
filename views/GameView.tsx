                ...
                >
                  ...
                  {!p.is_alive && (
                    <div className="absolute inset-0 z-30 pointer-events-none">
                      ...
                      {/* 蓋在頭像上的淘汰章 */}
                      <div className={`absolute left-1/2 -translate-x-1/2 transition-all duration-700 ease-out ${isJustEliminated ? 'top-24 scale-100 opacity-95' : 'top-[48px] scale-[2.3] opacity-0'}`}>
                      ...
                      {/* 底部身分標籤 */}
                      <div className={`absolute transition-all duration-700 ease-out ${isJustEliminated ? 'left-1/2 top-[80%] -translate-x-1/2 scale-[1.6] opacity-100' : 'right-4 bottom-5 scale-100 opacity-95'}`}>
