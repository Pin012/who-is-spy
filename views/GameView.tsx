                ...
                >
                  ...
                  {!p.is_alive && (
                    <div className="absolute inset-0 z-30 pointer-events-none">
                      ...
                      {/* 底部身分標籤 */}
                      <div className={`absolute transition-all duration-700 delay-500 ease-out ${isJustEliminated ? 'left-1/2 top-[60%] -translate-x-1/2 scale-[1.6] opacity-100' : 'right-4 bottom-5 scale-100 opacity-95'}`}>
