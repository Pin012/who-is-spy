                ...
                >
                  ...
                  {!p.is_alive && (
                    <div className="absolute inset-0 z-30 pointer-events-none">
                      ...
                      {/* 底部身分標籤 */}
                      <div className={`absolute transition-all duration-700 ease-out ${isJustEliminated ? 'right-20 bottom-8 scale-[2] opacity-100' : 'right-4 bottom-5 scale-100 opacity-95'}`}>
