                   ...
                   <div className="pb-12 pt-4 text-center relative z-10 px-8">
                    <p className="mb-2 text-[9px] text-zinc-500 font-black uppercase tracking-[0.4em]">MISSION ROLE</p>
                      ...
                      <div className="font-black text-sm uppercase tracking-[0.4em]">
                        {isSpectator ? <div className="flex flex-col items-center text-zinc-300 gap-2"><span className="text-[11px] tracking-[0.22em]">COMMANDER</span><span className="text-[13px] tracking-normal">- 指揮官 -</span></div> : currentPlayer.role === PlayerRole.UNDERCOVER ? <div className="flex flex-col items-center text-red-500 gap-2"><span className="text-[11px] tracking-[0.22em]">UNDERCOVER</span><span className="text-[13px] tracking-normal">- 臥底 -</span></div> : <div className="flex flex-col items-center text-cyan-400 gap-2"><span className="text-[11px] tracking-[0.22em]">CIVILIAN</span><span className="text-[13px] tracking-normal">- 平民 -</span></div>}
                      </div>
                   </div>
                </div>
