  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in zoom-in duration-500">
      <div className="text-center space-y-4">
        <h2 className="text-5xl font-black italic tracking-tighter text-white">CHOOSE MISSION TYPE</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div 
          ...
          className="group relative glass p-10 rounded-[2.5rem] border-2 border-white/5 hover:border-red-600/50 transition-all cursor-pointer overflow-hidden shadow-2xl hover:scale-[1.02] active:scale-95"
        >
          ...
          <div className="relative space-y-6">
            <div className="w-16 h-16 bg-red-600 rounded-2xl flex items-center justify-center text-3xl shadow-lg shadow-red-900/40">👤</div>
        ...
        <div 
          ...
          className="group relative glass p-10 rounded-[2.5rem] border-2 border-white/5 hover:border-amber-500/50 transition-all cursor-pointer overflow-hidden shadow-2xl hover:scale-[1.02] active:scale-95"
        >
          ...
          <div className="relative space-y-6">
            <div className="w-16 h-16 bg-amber-600 rounded-2xl flex items-center justify-center text-3xl shadow-lg shadow-amber-900/40">👁️</div>
            <div className="space-y-2">
              <h3 className="text-2xl font-black text-white tracking-tight">OBSERVER MODE (上帝視角)</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                房主僅作為主持人觀戰，不參與遊戲。房主需在準備階段<span className="text-amber-500 font-bold">手動輸入</span>平民與臥底的詞彙。
              </p>
            </div>
